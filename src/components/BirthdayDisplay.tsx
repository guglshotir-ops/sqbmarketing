...
const BirthdayDisplay = () => {
  ...
  if (!isLoaded) {
    return (
      <div className="fixed inset-0 bg-[#f4f7f9] flex items-center justify-center">
        <div className="text-[#004666]/50 text-2xl animate-pulse font-light tracking-widest">Loading...</div>
      </div>
    );
  }

  return (
    <div className="fixed inset-0 bg-[#f4f7f9] flex items-center justify-center overflow-hidden touch-none">
      {/* 
        Responsive Container: 
        Maintains 1536x3456 aspect ratio while fitting into any screen (Mobile or LED).
      */}
      <div
        className="relative bg-white shadow-2xl overflow-hidden"
        style={{
          aspectRatio: '1536 / 3456',
          height: '100vh',
          maxHeight: '100vh',
          width: 'auto',
      ...
      >
        {/* Internal content scaled to 1536px base */}
        <div className="absolute inset-0 w-[1536px] h-[3456px] origin-top-left"
          style={{ transform: 'scale(calc(100vh / 3456))' }}>
          ...
          <div className="relative z-20 h-full flex flex-col items-center justify-between py-40 px-16">
            <div className="flex flex-col items-center gap-8">
              <img src={sqbLogo} alt="SQB Bank" className="h-28 object-contain" />
                  ...
                  visibleData.map((person, index) => (
                    ...
                    >
                      <div className="relative py-8 px-20">
                        <h2 className="text-[90px] font-black text-[#004666] tracking-tight leading-none mb-4 whitespace-nowrap">
                          {person.name}
                        </h2>
